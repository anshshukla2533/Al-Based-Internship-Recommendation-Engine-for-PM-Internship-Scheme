...
export const AIChatMentor = ({ skills, language }) => {
    ...
    const [messages, setMessages] = useState([
        { role: "model", content: "Hello! I am your AI Mentor. Let me know if you need help with interview prep or learning new skills!" }
    ]);
    ...
    const sendChatMessage = async () => {
        ...
        try {
            ...
            setMessages([...newMsgs, { role: "model", content: "Oops! My connection dropped. Are you sure the server is running?" }]);
        }
    };
                    ...
                    >
                        ...
                        <div className="p-4 bg-white border-t border-gray-100 flex gap-3">
                            <input 
                                ...
                                placeholder="Ask for interview prep..."
                            />
                            <motion.button 
                                whileTap={{ scale: 0.9 }}
                                onClick={sendChatMessage} 
                                className="bg-gradient-to-tr from-purple-600 to-indigo-600 text-white w-12 h-12 rounded-xl flex items-center justify-center shadow-md hover:shadow-lg transition-all"
                            >
